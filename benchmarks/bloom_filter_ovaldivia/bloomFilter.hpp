...
static const uint primes[20] = {3079,
                                6151,
                                12289,
                                24593,
                                49157,
...
class bloomFilter {
    ...
    public:
        bloomFilter(size_t elements, double _err = 0.001) {
            ...
            size *= 0.80;
            // comment this line if the error rate is really important, this will provide lower error rate's
        ...
        // It checks if the element is in the array, if it's not, the element is added.
